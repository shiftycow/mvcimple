...
xslt_sheets = ["templates/mvcimple_error.xsl","templates/mvcimple_message.xsl","templates/add_greeting.xsl"];
    ...
    $.get("add",form_data,function(data)
                            {
                                ...
                                mvcimple_show_data(data,"templates/mvcimple_error.xsl","#add_greeting_result");
                                ...
                                mvcimple_show_data(data,"templates/mvcimple_message.xsl","#add_greeting_result");
                                 
                                //add another <li> into which we can put the new greeting
                                mvcimple_show_data(data,"templates/add_greeting.xsl");
                            });
}//end add_greeting
